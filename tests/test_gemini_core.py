...
@pytest.mark.asyncio
async def test_generic_gemini_initialization(mock_genai_client):
...
@pytest.mark.asyncio
async def test_ask_method(mock_genai_client, mock_chat_session):
    # Setup
...
@pytest.mark.asyncio
async def test_chat_method(mock_genai_client, mock_chat_session):
    # Setup
    mock_genai_client.chats.create.return_value = mock_chat_session
...
@pytest.mark.asyncio
async def test_function_calling(mock_genai_client, mock_chat_session):
